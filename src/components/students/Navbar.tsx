...
const Navbar = () => {
    ...
    return (
        <nav
            ...
            <div
                className={`absolute flex flex-col  items-center pt-4 gap-3 border-r-2 top-0 bottom-0 left-0 w-[60%] esm:w-[40%] bg-black/25 z-20 ${showSideMenu ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-500 ease-in-out text-white`}>
                <RxCross2
